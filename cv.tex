...
% \textbf{CERN}, Geneva, Switzerland: ATLAS sTGC & 2018 \\ \footnotesize{Assisted with construction and assembly of support jigs for the sTGC (new small wheel) modules}&\smallskip\\
